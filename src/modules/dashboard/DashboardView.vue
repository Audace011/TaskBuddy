  ...
  <div class="flex min-h-screen bg-bg-main dark:bg-dark-bg transition-colors duration-200">
    ...
    <main class="ml-64 flex-1 px-8 py-10 lg:px-12">
      ...
      <div v-else class="flex flex-col items-center justify-center py-24 px-6 text-center">
        ...
        <h3 class="text-task-title text-text-primary dark:text-text-light mb-2">Clean Slate</h3>
        <p class="text-body text-text-secondary dark:text-slate-400 max-w-sm">No tasks found for your current view. Time to start something new?</p>
      </div>

      <!-- Footer -->
      <footer class="mt-12 flex items-center justify-between border-t border-border-subtle dark:border-slate-800 pt-8">
        <p class="text-metadata font-semibold text-text-secondary uppercase tracking-widest">
          {{ t('lastSync') }}: just now
        </p>
        <p class="text-metadata font-semibold text-text-secondary opacity-50 uppercase tracking-widest">
